...
class PublicBuildTests(unittest.TestCase):
    ...
    def test_public_surface_uses_healthcare_analytics_visual_system(self) -> None:
        ...
        self.assertIn("--readout-text: #0e2442", app_source)
        self.assertIn("--readout-muted: #374151", app_source)
        ...
        self.assertIn("border-collapse: separate;", app_source)
        self.assertIn("box-shadow: 0 0 0 1px var(--readout-table-line);", app_source)
        self.assertIn("border-top-left-radius: 8px", app_source)
        self.assertIn("border-top-right-radius: 8px", app_source)
        ...
        self.assertNotIn("--readout-text: #111827", app_source)
        self.assertNotIn("--readout-muted: #4b5563", app_source)
        self.assertNotIn("#4b5563", app_source)
