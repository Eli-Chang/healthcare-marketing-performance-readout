...
class PublicBuildTests(unittest.TestCase):
    ...
    def test_public_surface_uses_healthcare_analytics_visual_system(self) -> None:
        app_source = (PROJECT_ROOT / "app.py").read_text(encoding="utf-8")
        self.assertIn("--readout-page: #081a36", app_source)
        ...
        self.assertIn("--readout-accent: #56b9b5", app_source)
        self.assertIn("--readout-positive: #7bb992", app_source)
        self.assertIn("--readout-negative: #d18489", app_source)
        self.assertIn("--readout-warning: #d4a54a", app_source)
        self.assertIn("--readout-table-bg: #132844", app_source)
        self.assertIn("--readout-table-header: #203a5d", app_source)
        ...
        self.assertIn("background: var(--readout-accent) !important", app_source)
